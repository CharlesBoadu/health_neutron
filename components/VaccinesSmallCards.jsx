...
function VaccinesSmallCards() {
  ...
  return (
    <>
      <div className="flex flex-row justify-center items-center space-x-3 py-2 z-1 hover:cursor-pointer" onClick={handleNavigationToVaccines}>
      ...
      <div className="flex flex-row justify-center items-center space-x-3 py-2 hover:cursor-pointer" onClick={handleNavigationToVaccines}>
        <div className="flex flex-col">
          <div className="w-[150px] h-[100px] bg-gray-300">
