...
function Footer() {
  ...
  function HandleNavigateToFacebook() {
    window.open(
      "https://web.facebook.com/healthneutron/?_rdc=2&_rdr",
      "_blank"
    );
  }
    ...
    <div className="md:w-full w-screen bg-[#232f3e] md:font-montserrat flex md:flex-row flex-col md:space-x-8 space-y-4 md:text-sm text-xl p-8">
      <div className="flex-1">
        ...
        <div className="text-white md:text-base text-sm md:leading-5 font-montserrat">
          The average life expectancy in Ghana in 2020 was 64 years. That of
          sub-Saharan African countries in the same year was 60 years. We at
          Healthneutron have decided to work on increasing life expectancy of
          developing countries by 1 year over the next 7 years (2030) through
        ...
        <div className="flex flex-row md:mt-4 mt-8 md:space-x-4 space-x-8">
          <div className="cursor-pointer" onClick={HandleNavigateToFacebook}>
            <FiFacebook
              size={20}
              color="white"
              className="md:h-6 md:w-7 h-8 w-8"
            />
          </div>
      ...
      <div className="flex md:flex-row md:space-x-6 flex-col md:py-0 md:justify-evenly md:space-y-0 space-y-8 py-8">
        <div className="flex text-white flex-col">
          ...
          <div className="flex flex-col md:space-y-2 space-y-2 md:text-base text-xs font-montserrat">
            <span
              onClick={handleNavigationToBusinessPortal}
              className="cursor-pointer"
            >
              Business Portal
            </span>
            <span
              onClick={handleNavigationToWebsite}
              className="cursor-pointer"
            >
              Website
            </span>
            <span onClick={handleNavigationToBlog} className="cursor-pointer">
              Blog
            </span>
          </div>
        </div>
