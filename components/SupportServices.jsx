...
function SupportServices() {
  return (
    <div className="flex md:flex-row flex-col md:justify-evenly md:space-y-0 items-center justify-center space-y-8 py-20 bg-[#e3e6e6] md:font-montserrat p-8">
      {/* <div className="flex flex-row md:w-[380px] space-x-3">
        ...
        <div className="flex flex-col md:space-y-3 md:space-x-0 space-x-4 md:mt-0 mt-8">
          ...
          <div className="md:text-base text-3xl font-montserrat">Contact us on +233 59 236 0072, +233 50 399 2309</div>
        </div>
      </div>
      <div className="flex flex-row md:w-[380px] space-x-3">
        <div>
        ...
        <div className="flex flex-col md:space-y-3 md:space-x-0 space-x-4 md:mt-0 mt-8">
          ...
          <div className="md:text-base text-3xl font-montserrat">We collect samples in the comfort of your home or office</div>
        </div>
      </div>
      <div className="flex flex-row md:w-[380px] space-x-3">
      <div>
        ...
        <div className="flex flex-col md:space-y-3 md:space-x-0 space-x-4 md:mt-0 mt-8">
          ...
          <div className="md:text-base text-3xl font-montserrat">We ensure secure payment with online payment services</div>
        </div>
      </div> */}
    </div>
  );
